...
use pocketmine\OldBlock\Block;
use pocketmine\command\OldCommandSender;
use pocketmine\customUI\CustomUI;
use pocketmine\OldEntity\Arrow;
use pocketmine\OldEntity\Effect;
use pocketmine\OldEntity\Entity;
use pocketmine\OldEntity\Human;
use pocketmine\OldEntity\Item as DroppedItem;
use pocketmine\OldEntity\Living;
use pocketmine\OldEntity\Projectile;
use pocketmine\oldevent\block\SignChangeEvent;
use pocketmine\oldevent\entity\EntityDamageByEntityEvent;
use pocketmine\oldevent\entity\EntityDamageEvent;
use pocketmine\oldevent\entity\EntityRegainHealthEvent;
use pocketmine\oldevent\entity\EntityShootBowEvent;
use pocketmine\oldevent\entity\ProjectileLaunchEvent;
use pocketmine\oldevent\inventory\CraftItemEvent;
use pocketmine\oldevent\inventory\InventoryCloseEvent;
use pocketmine\oldevent\inventory\InventoryPickupArrowEvent;
use pocketmine\oldevent\inventory\InventoryPickupItemEvent;
use pocketmine\oldevent\player\PlayerAnimationEvent;
use pocketmine\oldevent\player\PlayerBedEnterEvent;
use pocketmine\oldevent\player\PlayerBedLeaveEvent;
use pocketmine\oldevent\player\PlayerChatEvent;
use pocketmine\oldevent\player\PlayerCommandPreprocessEvent;
use pocketmine\oldevent\player\PlayerCommandPostprocessEvent;
use pocketmine\oldevent\player\PlayerCreationEvent;
use pocketmine\oldevent\player\PlayerDeathEvent;
use pocketmine\oldevent\player\PlayerDropItemEvent;
use pocketmine\oldevent\player\PlayerGameModeChangeEvent;
use pocketmine\oldevent\player\PlayerInteractEvent;
use pocketmine\oldevent\player\PlayerItemConsumeEvent;
use pocketmine\oldevent\player\PlayerJoinEvent;
use pocketmine\oldevent\player\PlayerKickEvent;
use pocketmine\oldevent\player\PlayerLoginEvent;
use pocketmine\oldevent\player\PlayerMoveEvent;
use pocketmine\oldevent\player\PlayerPreLoginEvent;
use pocketmine\oldevent\player\PlayerQuitEvent;
use pocketmine\oldevent\player\PlayerReceiptsReceivedEvent;
use pocketmine\oldevent\player\PlayerRespawnEvent;
use pocketmine\oldevent\player\PlayerRespawnAfterEvent;
use pocketmine\oldevent\player\PlayerToggleSneakEvent;
use pocketmine\oldevent\player\PlayerToggleSprintEvent;
use pocketmine\oldevent\server\DataPacketSendEvent;
use pocketmine\oldevent\TextContainer;
use pocketmine\oldevent\Timings;
use pocketmine\OldInventory\BaseTransaction;
use pocketmine\OldInventory\BigShapedRecipe;
use pocketmine\OldInventory\BigShapelessRecipe;
use pocketmine\OldInventory\EnchantInventory;
use pocketmine\OldInventory\Inventory;
use pocketmine\OldInventory\InventoryHolder;
use pocketmine\OldInventory\PlayerInventory;
use pocketmine\OldInventory\ShapedRecipe;
use pocketmine\OldInventory\ShapelessRecipe;
use pocketmine\OldInventory\SimpleTransactionGroup;
...
use pocketmine\OldMetadata\MetadataValue;
use pocketmine\nbt\NBT;
use pocketmine\nbt\tag\ByteTag;
use pocketmine\nbt\tag\Compound;
use pocketmine\nbt\tag\DoubleTag;
...
use pocketmine\OldInventory\PlayerInventory120;
use pocketmine\network\multiversion\Multiversion;
use pocketmine\network\multiversion\MultiversionEnums;
use pocketmine\network\protocol\LevelEventPacket;

use pocketmine\OldInventory\win10\Win10InvLogic;
