...
use pocketmine\block\OldBlock;
use pocketmine\command\OldCommandReader;
use pocketmine\command\OldCommandSender;
use pocketmine\command\OldConsoleCommandSender;
use pocketmine\command\OldPluginIdentifiableCommand;
use pocketmine\command\OldSimpleCommandMap;
use pocketmine\OldEntity\Arrow;
use pocketmine\OldEntity\Effect;
use pocketmine\OldEntity\Entity;
use pocketmine\OldEntity\FallingSand;
use pocketmine\OldEntity\Human;
use pocketmine\OldEntity\Item as DroppedItem;
use pocketmine\OldEntity\PrimedTNT;
use pocketmine\OldEntity\Snowball;
use pocketmine\OldEntity\Egg;
use pocketmine\OldEntity\Squid;
use pocketmine\OldEntity\Villager;
use pocketmine\oldevent\HandlerList;
use pocketmine\oldevent\level\LevelInitEvent;
use pocketmine\oldevent\level\LevelLoadEvent;
use pocketmine\oldevent\server\ServerCommandEvent;
use pocketmine\oldevent\Timings;
use pocketmine\oldevent\TimingsHandler;
use pocketmine\OldInventory\CraftingManager;
use pocketmine\OldInventory\InventoryType;
use pocketmine\OldInventory\Recipe;
use pocketmine\OldInventory\ShapedRecipe;
use pocketmine\OldInventory\ShapelessRecipe;
use pocketmine\OldInventory\FurnaceRecipe;
...
use pocketmine\OldMetadata\EntityMetadataStore;
use pocketmine\OldMetadata\LevelMetadataStore;
use pocketmine\OldMetadata\PlayerMetadataStore;
...
use pocketmine\OldEntity\animal\walking\Chicken;
use pocketmine\OldEntity\animal\walking\Cow;
use pocketmine\OldEntity\animal\walking\Mooshroom;
use pocketmine\OldEntity\animal\walking\Ocelot;
use pocketmine\OldEntity\animal\walking\Pig;
use pocketmine\OldEntity\animal\walking\Rabbit;
use pocketmine\OldEntity\animal\walking\Sheep;
use pocketmine\OldEntity\monster\flying\Blaze;
use pocketmine\OldEntity\monster\flying\Ghast;
use pocketmine\OldEntity\monster\walking\CaveSpider;
use pocketmine\OldEntity\monster\walking\Creeper;
use pocketmine\OldEntity\monster\walking\Enderman;
use pocketmine\OldEntity\monster\walking\IronGolem;
use pocketmine\OldEntity\monster\walking\PigZombie;
use pocketmine\OldEntity\monster\walking\Silverfish;
use pocketmine\OldEntity\monster\walking\Skeleton;
use pocketmine\OldEntity\monster\walking\SnowGolem;
use pocketmine\OldEntity\monster\walking\Spider;
use pocketmine\OldEntity\monster\walking\Wolf;
use pocketmine\OldEntity\monster\walking\Zombie;
use pocketmine\OldEntity\monster\walking\ZombieVillager;
use pocketmine\OldEntity\projectile\FireBall;
use pocketmine\utils\MetadataConvertor;
use pocketmine\oldevent\server\SendRecipiesList;
